# Generated by Powerlevel10k configuration wizard on 2023-09-14 at 22:48 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%242FÃ-'
  ...
  # Filler between left and right prompt on the first prompt line. You can set it to ' ', 'ú' or
